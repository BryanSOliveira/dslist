...
Este projeto é uma aplicação de exemplo desenvolvida usando o Spring Boot, que permite a criação e gerenciamento de listas de jogos. Cada jogo pode estar presente em várias listas e é possível ordenar os jogos dentro de cada lista.

## Funcionalidades

- Cadastro de jogos.
- Criação de listas de jogos personalizadas.
- Adição e remoção de jogos em uma lista.
- Ordenação flexível de jogos dentro de cada lista.
...
1. **Clone o repositório:**
    ...
    ```
    git clone https://github.com/BryanSOliveira/dslist.git
    ```
